...
public sealed class AppSettings
{
    ...
    /// <summary>Which selection edge the mini-toolbar attaches to (or docked to the main bar).</summary>
    public SelectionToolbarPlacement SelectionToolbarPlacement { get; set; } = SelectionToolbarPlacement.Left;
